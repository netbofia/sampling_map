...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Chart.js/README.md at master · nnnick/Chart.js · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars2.githubusercontent.com/u/1458051?v=2&amp;s=400" property="og:image" /><meta content="nnnick/Chart.js" property="og:title" /><meta content="https://github.com/nnnick/Chart.js" property="og:url" /><meta content="Chart.js - Simple HTML5 Charts using the &lt;canvas&gt; tag" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="365B683D:09A1:4605FD7:54428C72" name="octolytics-dimension-request_id" />
...
<meta content="1CvFMfiDNOLjC7Zoy/aobZJ86YB8Ix5DQdbMeIvqpqrk/lDumVHYZ6G2nQfGGHxVxiTwlDfPgYcZx9fWCkVjjA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="button signin" href="/login?return_to=%2Fnnnick%2FChart.js%2Fblob%2Fmaster%2FREADME.md" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="sunken-menu vertical-right repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders" role="navigation" data-issue-count-url="/nnnick/Chart.js/issues/counts" data-pjax-container-selector="#js-repo-pjax-container">
...
<a href="/nnnick/Chart.js/blob/1cfa42bc24e152cfef79523c310fae7d4c458635/README.md" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:90ae24affdbd1a4206476496e3d584e0 -->
...
<div class="select-menu js-menu-container js-select-menu left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              ...
              <a href="/nnnick/Chart.js/blob/feature/version-bump/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/blob/fix/skip-non-numeric-points/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/blob/fix/sparse-datasets/README.md"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/blob/master/README.md"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v1.0.1-beta.4/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v1.0.1-beta.3/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v1.0.1-beta.2/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v1.0.1-beta/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v1.0.0-beta/README.md"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nnnick/Chart.js/tree/v0.2.0/README.md"
                 data-name="v0.2.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        <img alt="William Entriken" class="avatar" data-user="382183" height="24" src="https://avatars2.githubusercontent.com/u/382183?v=2&amp;s=48" width="24" />
        <span class="author"><a href="/fulldecent" rel="contributor">fulldecent</a></span>
        <time datetime="2014-09-15T12:16:31-04:00" is="relative-time">September 15, 2014</time>
        <div class="commit-title">
            <a href="/nnnick/Chart.js/commit/401ff95867f18e2b035dabc3cf61b7cee9e778d9" class="message" data-pjax="true" title="move contributing to CONTRIBUTING.md, helps with NEW ISSUES">move contributing to CONTRIBUTING.md, helps with NEW ISSUES</a>
        </div>
    </div>
    ...
    <div class="participation">
      <p class="quickstat">
        <a href="#blob_contributors_box" rel="facebox">
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="nnnick" href="/nnnick/Chart.js/commits/master/README.md?author=nnnick"><img alt="Nick Downie" class="avatar" data-user="1458051" height="20" src="https://avatars0.githubusercontent.com/u/1458051?v=2&amp;s=40" width="20" /></a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="fulldecent" href="/nnnick/Chart.js/commits/master/README.md?author=fulldecent"><img alt="William Entriken" class="avatar" data-user="382183" height="20" src="https://avatars0.githubusercontent.com/u/382183?v=2&amp;s=40" width="20" /></a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          ...
          <li class="facebox-user-list-item">
            <img alt="William Entriken" data-user="382183" height="24" src="https://avatars2.githubusercontent.com/u/382183?v=2&amp;s=48" width="24" />
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/nnnick/Chart.js/raw/master/README.md" class="minibutton " id="raw-url">Raw</a>
            <a href="/nnnick/Chart.js/blame/master/README.md" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/nnnick/Chart.js/commits/master/README.md" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<p>When reporting bugs or issues, if you could include a link to a simple <a href="http://jsbin.com">jsbin</a> or similar demonstrating the issue, that'd be really helpful.</p></article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02910s from github-fe135-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
